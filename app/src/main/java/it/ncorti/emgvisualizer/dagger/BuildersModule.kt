...
import it.ncorti.emgvisualizer.ui.graph.GraphIMUFragment
...
abstract class BuildersModule {
    ...
    @ContributesAndroidInjector(modules = [GraphIMUViewModule::class, GraphIMUModule::class])
    abstract fun bindGraphIMUFragment(): GraphIMUFragment
